...
const STORAGE_KEY = "analytik-gemini-key";
...
export function ApiKeyProvider({ children }: { children: ReactNode }) {
    ...
    return (
        <ApiKeyContext.Provider value={{ apiKey, isSignedIn: Boolean(apiKey), saveKey, clearKey, showModal, hideModal, isModalOpen, requireAuth, pendingAction }}>
            {children}
